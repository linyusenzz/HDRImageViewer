...
- Current project/MSIX version: `1.0.18.0`.
- Current maintained native dependency platform: x64.
- Current local package output:

```text
AppPackages\HdrImageViewer_1.0.18.0_x64_Test
```
...
```text
AppPackages\HdrImageViewer_1.0.18.0_x64_Test\HdrImageViewer_1.0.18.0_x64.msix
```
...
- `AppPackages\HdrImageViewer_1.0.18.0_x64_Test`: about `109.8 MB`.
