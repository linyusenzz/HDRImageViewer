...
- Current project/MSIX version: `1.0.24.0`.
- Current maintained native dependency platform: x64.
- Current local package output:

```text
AppPackages\HdrImageViewer_1.0.24.0_x64_Test
```
...
```text
AppPackages\HdrImageViewer_1.0.24.0_x64_Test\HdrImageViewer_1.0.24.0_x64.msix
```
...
- `AppPackages\HdrImageViewer_1.0.24.0_x64_Test`: about `232.4 MB`; the generated MSIX is about `109.9 MB`.
