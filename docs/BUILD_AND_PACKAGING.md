...
- Current project/MSIX version: `1.0.20.0`.
- Current maintained native dependency platform: x64.
- Current local package output:

```text
AppPackages\HdrImageViewer_1.0.20.0_x64_Test
```
...
```powershell
.\eng\publish-portable.ps1 -Version 1.0.20.0 -Platform x64
```
...
```text
AppPackages\HdrImageViewer_1.0.20.0_x64_Test\HdrImageViewer_1.0.20.0_x64.msix
```
...
- `AppPackages\HdrImageViewer_1.0.20.0_x64_Test`: about `232.39 MB`; the generated MSIX is about `109.8 MB`.
